  ...
  //                  regpt = locator.getRegisterPort(new URL(url.get(0).getValeur()));
              ...
              newAbonnement.setCoderetour(String.valueOf(codeRetour));
                ...
                if (codeRetour == 0) {
                    ...
                    sessionManager.logDB();
                    addErrorMessage("ERREUR", "La souscription a échoué " + codeRetour + ":" + rbar.getDescription());
                }
...
//            
    ...
    public void updateAccountLabel() {
        ...
        paymentRequest.setCommissions(airtel.getIdOperateur().longValue());  /// operateur à la place de commissions
