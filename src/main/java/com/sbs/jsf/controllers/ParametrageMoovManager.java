 ...
 * @author SOCITECH-
 */
@ManagedBean(name = "parametrageMoovManager")
@ApplicationScoped
public class ParametrageMoovManager implements Serializable {
