 ...
 * @author samuel
 */
@ManagedBean(name = "parametrageOnatelManager")
@ApplicationScoped
public class ParametrageOnatelManager implements Serializable {
    ...
    public ParametrageOnatelManager() {
    }
...
//            }
            ...
            listPagesouscription = pagesouscriptionFacade.findByOperateur("ONATEL");
