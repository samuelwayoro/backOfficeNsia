 ...
 * @author SOCITECH-
 */
public class ProfilsFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(loginManager.getUtilisateur().getIdprofils().getCreationProfils()||loginManager.getUtilisateur().getIdprofils().getModificationProfils()||loginManager.getUtilisateur().getIdprofils().getSuppressionProfils() ){
